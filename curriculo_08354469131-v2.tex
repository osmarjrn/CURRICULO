...
\begin{itemize}[noitemsep, label={--}]
    ...
    \item Java: Linguagem de programação orientada a objetos I;
...
\begin{itemize}[noitemsep, label={$\bullet$}]
    \item \textbf{Membro da Empresa Júnior de Computação da UFPR;}\\
    Voluntário para Assessoria de Projetos. (92 horas)\\
    Administração de arquivos.
     \vspace{0.2cm}
    \item \textbf{Como aluno de TADS;}\\
...
\section*{Dos valores}
Disciplina, autonomia, iniciativa de atitude, liderança, espírito de corpo e aprendizagem.

\section*{Do almejado}
Em busca de vínculo empregatício com oportunidade de aquisição da experiência da função, e de contribuir efetivamente.

\vspace{1cm}
\hrule
\vspace{0.3cm}
\small
\textbf{Informações de Contato Adicionais:} \\
CPF: 083.544.691-31 \\
Endereço: Rua Hercílio Kulcheski, 149 - CEP: 81315-330 \\
Deslocamento: Até 45m de deslocamento (Transporte Público)
\end{document}
