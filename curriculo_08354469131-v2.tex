...
Estudante de Tecnologia em Análise e Desenvolvimento de Sistemas na Universidade Federal do Paraná (IRA: 0.812/1). Ensino Médio certificado pelo Colégio Militar de Curitiba (MG: 8.5/10).
...
\item \textbf{HTML, CSS, JavaScript:} Desenvolvimento Web I (2º período);
...
\item Comunicação e negociação eficientes e eficazes;
\item Redação de textos coesos e coerentes em norma culta;
\item Idiomas: Português nativo e Inglês intermediário (conversação e escrita).
\end{itemize}

\section*{Das experiências}
\begin{itemize}[noitemsep, label={$\bullet$}]
  \item \textbf{Estagiário de TI -- Centro RPG Curitiba}\\
\textit{Suporte e Desenvolvimento de TI (750 horas)}\\
...
\textit{Voluntário em Assessoria de Projetos (92 horas)}\\
...
\textit{Tecnologia em Análise e Desenvolvimento de Sistemas (20 horas)}\\
Implementação em equipe de um jogo web interativo para digitação de cores.
\vspace{0.2cm}

\item \textbf{Suporte Técnico Independente}\\
\textit{Manutenção de Hardware e Software (Autônomo)}\\
